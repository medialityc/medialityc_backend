...
{
    public class GetAllProjectLandingEndpoint(IMedialitycDbContext dbContext) : Endpoint<GetAllProjectRequest,
        Results<Ok<PaginatedResponse<GetAllProjectResponse>>, ProblemHttpResult>>
    {
        public override void Configure()
        {
            Get("/projects/landing/all");
            AllowAnonymous();
            Description(x => x
                .WithName("GetAllProjectsLanding")
                .Produces<PaginatedResponse<GetAllProjectResponse>>(StatusCodes.Status200OK)
                .ProducesProblem(StatusCodes.Status500InternalServerError));
        }

        public override async Task<Results<Ok<PaginatedResponse<GetAllProjectResponse>>, ProblemHttpResult>>
